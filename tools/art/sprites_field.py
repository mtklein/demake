...
SPRITES = {
    ...
    "zevlor": {"pal": 6, "frames": ["zevlor_down0", "zevlor_down1", "zevlor_up0", "zevlor_up1", "zevlor_side0", "zevlor_side1"]},
    "wyll": {"pal": 4, "frames": ["wyll_down0", "wyll_down1", "wyll_up0", "wyll_up1", "wyll_side0", "wyll_side1"]},
    ...
    "gobf": {"pal": 1, "frames": ["gobf0", "gobf1"]},
    "gobboss": {"pal": 1, "frames": ["gobboss0", "gobboss1"]},
...
FRAMES = {
    ...
    # ---- Zevlor: elderly Hellrider commander (pal 6) — bald maroon head,
    #      one swept-back horn + one broken stub, white goatee, dark armor
    #      with gold chest emblem, longsword sheathed at the hip ----
    "zevlor_down0": [
        ".44.............",
        "..44.111111.....",
        "..441222222144..",
    ...
    # ---- Wyll: the Blade of Frontiers (pal 4) — black cropped hair drawn
    #      in outline ink, circle beard, stone left eye (lone W), gold-trim
    #      coat, thin white rapier carried upright ----
    "wyll_down0": [
        "................",
        ".....111111.....",
        "....11111111....",
    ...
    # ---- wild boar: low bulky trotter, bristle ridge, tusks ----
    "boarw_down0": [
        "................",
        "................",
        "................",
    ...
    # ---- feral intellect devourer: crouched brain on clawed legs ----
    "devf0": [
        "................",
        "................",
        "................",
    ...
    # ---- tiefling scavenger: scared, hooded, tail flicking ----
    "scav0": [
        "................",
        "................",
        "................",
    ...
    # ---- chapel looters (pal 7): bare-headed human tomb-robbers, bandana
    #      band and a raised iron pry-bar. No hood, no horns, no tail -- a
    #      different silhouette from the tiefling scavengers, so the band at
    #      the tomb door reads as its own gang. The bar's hook swings frame
    #      to frame over the idle bob ----
    "loot0": [
        "................",
        "................",
        ".....44444......",
    ...
    # ---- Withers: gaunt hooded keeper of ledgers (pal 5); the lamplit
    #      sockets blink out between frames ----
    "withersf0": [
        "................",
        ".....11111......",
        "....1444441.....",
    ...
    # ---- goblin raider (pal 1): yellow-green skin, up-pricked ears, tusked
    #      maw, one scrap-iron pauldron, jagged blade held low; frame 1 is
    #      the scav-style 1px prowl bob ----
    "gobf0": [
        "................",
        "................",
        "................",
    ...
    # ---- goblin warchief (pal 1): full head taller than gobf — horned iron
    #      half-helm, gold chest chain, wide stance, big jagged cleaver held
    #      high; frame 1 pumps the body down a pixel behind planted feet ----
    "gobboss0": [
        ".4............4.",
        "..4..........4..",
        "...4111111114...",
    ...
    "wyll_ko": [  # black cropped hair (outline ink), rapier dropped below
        "................",
        "................",
        "................",
        "................",
