...
MONSTERS = {
    ...
    "intellect devourer": {
        ...
        "attacks": [
            {"name": "Claws", "to_hit": 4, "dice": "1d6", "plus": 2,
             "dmg_type": "slashing"},
            {"name": "Synaptic Jolt", "to_hit": 4, "dice": "1d8", "plus": 2,
             "dmg_type": "psychic"},
        ],
    ...
    "lesser cambion": {
        ...
        "attacks": [
            ...
            {"name": "Fire Ray", "to_hit": 5, "dice": "2d6", "plus": 0,
             "dmg_type": "fire"},
        ],
    ...
    "mind flayer ally": {
        ...
        "attacks": [
            {"name": "Tentacles", "to_hit": 7, "dice": "2d10", "plus": 4,
             "dmg_type": "psychic"},
            {"name": "Mind Blast", "to_hit": 7, "dice": "3d8", "plus": 0,
             "dmg_type": "psychic"},
        ],
        "resistances": [], "immunities": [],
    },
        ...
        "attacks": [
            {"name": "Everburn Blade", "to_hit": 7, "dice": "2d6", "plus": 4,
             ...
             "extra": {"save": ("dex", 12), "dice": "1d4",
                       "dmg_type": "fire", "half_on_save": True}},
            {"name": "Fire Ray", "to_hit": 6, "dice": "3d6", "plus": 0,
             "dmg_type": "fire"},
        ],
        "resistances": ["cold", "fire", "poison"], "immunities": [],
    },
