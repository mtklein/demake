...
for scn in bard_full wizard_zhalk rogue_mutilate ranger_full \
           ...
           wildshape_check levelup_check prepare_check origin_check durge_check; do
    ...
    case "$scn" in tether_check|panic_check|wildshape_check|levelup_check|prepare_check|origin_check|durge_check) ;; *)
